  ...
  Future<void> _loadMyCourses() async {
    try {
      ...
      if (userId == null) {
        setState(() {
          _loading = false;
          _debug = 'No user id found. auth.user = ${auth.user}';
        });
        return;
      }

      final url = 'https://api.selectionlab.online/api/users/$userId/courses';
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          ...
          _loading = false;
          _debug = 'userId=$userId | status=200 | courses=${_courses.length}';
        });
      } else {
        setState(() {
          _loading = false;
          _debug = 'userId=$userId | status=${res.statusCode} | body=${res.body}';
        });
      }
    } catch (e) {
      setState(() {
          ...
          children: [
            ...
            if (_debug.isNotEmpty)
              Container(
                ...
                child: SelectableText('DEBUG: $_debug',
