...
class _DescriptivePlayerScreenState extends State<DescriptivePlayerScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('build v2',
                  style: TextStyle(color: kDGold, fontWeight: FontWeight.w800)),
              const SizedBox(height: 10),
              Text(_error!, style: TextStyle(color: t.text, fontSize: 13)),
            ],
          ),
        ),
      );
    ...
    return Scaffold(
      backgroundColor: t.bg,
      appBar: AppBar(
        backgroundColor: kDGreen, // TEST MARKER v4
        elevation: 0,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      color: kDGold,
                      child: Text(
                          'v4 · questions:$_dbgQ · sections:${_sections.length} · here:${qs.length}',
                          style: const TextStyle(
