                    ...
                    trailing: GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(
                          builder: (_) => const CourseListScreen(title: 'All Courses', courseType: 'Paid Batch'),
                        ));
                      },
  ...
  void _handleTap(BuildContext context, String label) {
    ...
    switch (label) {
      ...
      case "PYQ's":
        ...
        break;
      case 'Free Quiz':
        Navigator.push(context, MaterialPageRoute(builder: (_) => const QuizHomeScreen()));
        return;
    }
    if (courseType != null) {
      Navigator.push(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.assignment_rounded, size: 40, color: Color(0xFF2196F3)),
            ),
            const SizedBox(height: 18),
            Text('Mock Tests', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87)),
            const SizedBox(height: 10),
            Text(
              'Full-length mock tests with detailed analysis are available on our website. The in-app experience is coming soon!',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () async {
                  Navigator.pop(ctx);
                  final uri = Uri.parse('https://selectionlab.online');
                  if (await canLaunchUrl(uri)) {
                    await launchUrl(uri, mode: LaunchMode.externalApplication);
                  }
                },
            ...
            TextButton(
              ...
              child: Text('Maybe Later', style: TextStyle(color: isDark ? Colors.white54 : Colors.black45)),
            ),
          ],
        ),
      ),
