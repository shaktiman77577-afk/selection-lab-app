...
class _DashboardTabState extends State<DashboardTab> {
  ...
  void _openCourse(BuildContext context, Map<String, dynamic> c) {
    Navigator.push(
      context,
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () => _openCourse(context, c),
...
class _DynamicBannerSliderState extends State<_DynamicBannerSlider> {
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final hasImage = b['image_url'] != null && b['image_url'].toString().isNotEmpty;
              return GestureDetector(
                onTap: () {
                  if (b['redirect_url'] != null) widget.onLaunchUrl(b['redirect_url']);
                },
                child: hasImage
                    ? Container(
  ...
  Widget _gradientBanner(Map<String, dynamic> b) {
    final startColor = b['gradient_start'] != null
        ? _hexToColor(b['gradient_start'])
        : AppColors.primary;
    final endColor = b['gradient_end'] != null
        ? _hexToColor(b['gradient_end'])
...
class _StaticBannerSliderState extends State<_StaticBannerSlider> {
  ...
  final List<Map<String, dynamic>> _banners = [
    {'title': 'Get Premium!', 'subtitle': 'Unlock all exams for just ₹99/month', 'colors': [Color(0xFFFF6B00), Color(0xFFFF8E53)], 'btnText': 'Get Now', 'icon': Icons.star_rounded},
    {'title': 'Mock Tests', 'subtitle': 'Practice with real exam pattern questions', 'colors': [Color(0xFF1A237E), Color(0xFF3949AB)], 'btnText': 'Start Now', 'icon': Icons.assignment_rounded},
    {'title': 'Study Material', 'subtitle': 'Access notes & PDFs for all exams', 'colors': [Color(0xFF1B5E20), Color(0xFF43A047)], 'btnText': 'Explore', 'icon': Icons.menu_book_rounded},
  ];
...
class _ConnectSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final links = [
      {'icon': Icons.play_circle_filled_rounded, 'label': 'YouTube', 'color': const Color(0xFFFF0000), 'url': 'https://youtube.com/@selection_lab'},
      {'icon': Icons.chat_rounded, 'label': 'WhatsApp', 'color': const Color(0xFF25D366), 'url': 'https://whatsapp.com/channel/0029Vb6Z3mEEawdkjDg60a1w'},
      {'icon': Icons.send_rounded, 'label': 'Telegram', 'color': const Color(0xFF0088CC), 'url': 'https://t.me/englishbynikki07'},
    ];
    return Row(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(l['label'] as String, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: color)),
                ],
              ),
            ),
          ),
