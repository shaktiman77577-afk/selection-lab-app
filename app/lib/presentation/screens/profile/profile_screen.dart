...
class ProfileScreen extends StatelessWidget {
  ...
  // ── Support / Social ──
  static const String supportNumber = '918860055778'; // 91 = India code
  static const String whatsappChannel = 'https://whatsapp.com/channel/0029Vb6XXXXXXXX'; // update if needed
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // ── OTHERS ──
            _sectionCard(isDark, [
              _menuItem(isDark, Icons.star_rounded, 'Rate App', 'Love the app? Rate us', () {}, iconColor: Colors.amber),
