  ...
  void _openContent(Map<String, dynamic> item) {
    ...
    if (type == 'video' && item['youtube_id'] != null) {
      Navigator.push(context, MaterialPageRoute(
        builder: (_) => VideoPlayerScreen(youtubeId: item['youtube_id'], title: item['title'] ?? 'Video'),
      ));
    } else if ((type == 'pdf' || type == 'file') && item['file_url'] != null) {
      Navigator.push(context, MaterialPageRoute(
        builder: (_) => PdfViewerScreen(url: item['file_url'], title: item['title'] ?? 'Document'),
      ));
    }
  }
              ...
              background: Stack(
                ...
                children: [
                  course['thumbnail_url'] != null
                      ? Image.network(course['thumbnail_url'], fit: BoxFit.cover,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('4.8', style: TextStyle(fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87, fontSize: 13)),
                      const SizedBox(width: 4),
                      Text('(1250+ enrolled)', style: TextStyle(color: isDark ? Colors.white54 : Colors.black45, fontSize: 12)),
                    ],
                  ),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text('Rs.$price', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.primary)),
                        if (hasDiscount) ...[
                          const SizedBox(width: 6),
                          Text('Rs.$originalPrice', style: const TextStyle(fontSize: 13, color: Colors.grey, decoration: TextDecoration.lineThrough)),
                        ],
                      ],
                    ),
                    if (hasDiscount)
            ...
            if (!isFree) const SizedBox(width: 16),
            Expanded(
              flex: isFree ? 1 : 2,
              child: ElevatedButton(
                onPressed: () {
                  ...
                  } else if (course['redirect_url'] != null) {
                ...
                child: Text(isFree ? 'Start Learning' : 'Buy Now', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
