                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            Container(
                              ...
                              child: isSelected ? const Icon(Icons.check, size: 16, color: Colors.white) : Center(child: Text(key, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.grey, fontSize: 13))),
                            ),
