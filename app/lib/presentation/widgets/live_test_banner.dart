  ...
  Future<void> _register() async {
    ...
    try {
      final r = await http.post(
        Uri.parse('${AppConstants.apiUrl}/mock-tests/${_test!['id']}/register'),
                  ...
                  children: [
                    if (running && !attempted)
                      _primary('▶ Start Test Now',
                          () => widget.onStartTest?.call(t['id'] as int)),
                    ...
                    if (published) ...[
                      _primary('🏆 View your Result & Rank',
                          () => widget.onViewResult?.call(t['id'] as int)),
                      _secondary('📖 View solutions',
                          () => widget.onViewSolutions?.call(t['id'] as int)),
                    ],
